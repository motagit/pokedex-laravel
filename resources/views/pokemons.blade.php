    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-0 dark:bg-gray-800 shadow sm:rounded-lg" style="padding: 10px 0">
            @if (Auth::check())
                ...
                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="default-button dark:bg-gray-900 dark:text-white sm:rounded-lg right" style="margin-left: 10px; display: flex; align-items: center; gap: 10px">
